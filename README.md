...
- Position yourself so your hand is visible to the webcam.
- Move your hand horizontally across the top strip of the window.
- The keys will turn green when triggered.
- Press ESC to exit the application.
# Technical Details
- Color Masking: Uses cv2.inRange with HSV values:
- - Lower: [0, 40, 60]
  - Upper: [20, 255, 255]
- Frequency Logic: The notes are mapped to standard scientific pitch frequencies:| Note | Frequency (Hz) |
  | :--- | :--- |
  | C4   | 261.63 |
  | A4   | 440.00 |
  | C5   | 523.25 |
